...
const Intro = React.forwardRef(
  (props: any, ref: React.MutableRefObject<HTMLDivElement>) => {
    return (
      <section ref={ref} id="Intro" className="w-full z-50 h-screen -mt-16">
        <img
        ...
        <div className="w-full  z-30 h-screen  flex-col absolute top-0 flex items-center justify-center text-white">
          ...
          <div className="absolute bottom-4">
            <a onClick={() => ScrollIntoView(props.aboutRef, "About")}>
