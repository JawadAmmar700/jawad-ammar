...
const CommentsView = ({ session }: { session: Session | null }) => {
  ...
  return (
    <div className="flex-1 mt-5 relative flex flex-col ">
      <div className="w-full h-[370px] overflow-y-scroll flex flex-col  hide-scroll-bar">
        {isLoading ? (
      ...
      {session && (
        <div className="h-10">
          <form
            className="absolute botton-0 w-full h-10 flex px-2 items-center shadow-inner justify-center bg-slate-100 rounded"
