    ...
    <div className="absolute top-0 w-full h-full flex flex-col">
      <div className="w-full h-full relative mt-2">
        <div className="w-full overflow-y-scroll flex flex-col hide-scroll-bar">
          ...
          {isLoading ? (
            ...
            <>
              ...
              <div className={`mb-2 h-[350px] py-2`}>
                {comments.map((comment: Comment, id: number) => (
                  <motion.div
                    ...
                    key={comment.id}
                    className="flex flex-col p-2 rounded mb-2 shadow-md bg-white"
                  >
                    <div
        ...
        {session && (
          <div className="h-10">
            <form
              className="absolute bottom-4 w-full h-10 flex px-2 items-center shadow-inner justify-center bg-slate-100 rounded"
